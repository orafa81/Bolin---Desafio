    ...
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      ...
      <form @submit.prevent="submit" :disabled="form.processing">
        ...
        <button
          ...
          class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-bombom-300 rounded-lg focus:ring-4 focus:ring-primary-200 hover:bg-primary-800"
        >
